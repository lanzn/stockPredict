...
def financial_data_income_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "income/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "income.csv"
...
def financial_data_balancesheet_df_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "balancesheet/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "balancesheet.csv"
...
def financial_data_cashflow_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "cashflow/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "cashflow.csv"
...
def financial_data_forecast_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "forecast/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "forecast.csv"
...
def financial_data_express_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "express/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "express.csv"
...
def financial_data_dividend_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "dividend/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "dividend.csv"
...
def financial_data_fina_indicator_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "fina_indicator/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "fina_indicator.csv"
...
def financial_data_fina_audit_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "fina_audit/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "fina_audit.csv"
...
def financial_data_fina_mainbz_processor(stock_code):
    ...
    csv_path = FINANCIAL_REPORT_ROOT_PATH + "fina_mainbz/" + stock_code[:6] + "_" + stock_code[7:9] + "_" + \
               "fina_mainbz.csv"
    fina_mainbz_df.to_csv(csv_path, index=False, index_label=False)


def financial_data_processor(stock_code, data_type):
    try:
        if data_type == 1:
        ...
        if data_type == 1:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "income/" + "Data_record", "a")
        elif data_type == 2:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "balancesheet/" + "Data_record", "a")
        elif data_type == 3:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "cashflow/" + "Data_record", "a")
        elif data_type == 4:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "forecast/" + "Data_record", "a")
        elif data_type == 5:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "express/" + "Data_record", "a")
        elif data_type == 6:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "dividend/" + "Data_record", "a")
        elif data_type == 7:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "fina_indicator/" + "Data_record", "a")
        elif data_type == 8:
            financial_record_file = open(FINANCIAL_REPORT_ROOT_PATH + "fina_audit/" + "Data_record", "a")
        else:
...
def financial_data_traverse(data_type):
